...
To run all notebook cells successfully, ensure:

- Python **3.9+**
- Internet access (dataset is loaded from a Google Drive URL in the notebook)
- Jupyter Notebook or JupyterLab installed
- Required packages installed

```bash
pip install -r requirements.txt
pip install jupyterlab ipykernel shap xgboost statsmodels seaborn
```

Then start Jupyter and run cells in order:

```bash
jupyter lab
```
## Vizualizations
[Tableau Dashboards](https://public.tableau.com/views/InsuranceCostPrediction_17768435336320/SummaryDashboard?:language=en-GB&:sid=&:display_count=n&:origin=viz_share_link)

## Technical Blog
[Medium Blog](https://medium.com/@anuravichandran.16.al/predicting-health-insurance-costs-with-machine-learning-from-eda-to-explainable-deployment-4ffb83eb326b)

## Public Streamlit Application
[Streamlit Application](https://insurance-cost-prediction-ml.streamlit.app/)

## Contact

**Anandalakshmi R**
- GitHub: [@Anandalakshmi-anu](https://github.com/Anandalakshmi-anu)
